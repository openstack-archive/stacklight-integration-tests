...
class TestToolchainReducedFootprint(api.ToolchainApi):
    ...
    def deploy_toolchain_with_reduced_footprint(self):
        ...
        footpriint feature (aka virt nodes).
        ...
        Scenario:
            ...
            7. Add 1 node with virt role
            8. Spawn 1 virtual machine on the virt node
        ...
        nailgun_client.create_vm_nodes(
            virt_node["id"], [{"id": 1, "mem": vm_ram, "cpu": 1}])
        ...
        vm_node["pending_roles"] = settings.stacklight_roles
        nailgun_client.update_nodes(vm_node)
