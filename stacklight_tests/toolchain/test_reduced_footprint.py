...
class TestToolchainReducedFootprint(api.ToolchainApi):
    ...
    def deploy_toolchain_virt_nodes(self):
        ...
        self.checkers.enable_feature_group(self.env, "advanced")
        ...
        initial_nodes = fuel_web.client.list_nodes()
        virt_node = None
        ...
        wait(lambda: len(fuel_web.client.list_nodes()) == 4,
             timeout=10 * 60,
        ...
        vm_node = None
        for i in fuel_web.client.list_nodes():
