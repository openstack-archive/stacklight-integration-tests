...
class TestOpenstackTelemetry(api.ToolchainApi):
    ...
    @test(depends_on_groups=["prepare_slaves_5"],
          groups=["deploy_telemetry_event_api", "functional"])
    @log_snapshot_after_test
    def deploy_telemetry_event_api(self):
        """Deploy an environment with Openstack-Telemetry and StackLight
        ...
        self._deploy_telemetry_plugin("deploy_telemetry_event_api",
                                      additional_tests=additional_tests,
                                      advanced_options=options
                                      )

    @test(depends_on_groups=["prepare_slaves_5"],
          groups=["deploy_telemetry_resource_api", "functional"])
    @log_snapshot_after_test
    def deploy_telemetry_resource_api(self):
        """Deploy an environment with Openstack-Telemetry and StackLight
        ...
        self._deploy_telemetry_plugin(
            "deploy_telemetry_resource_api",
            additional_tests=additional_tests,
            advanced_options=options
        )

    @test(depends_on_groups=["prepare_slaves_5"],
          groups=["deploy_telemetry_resource_event_api", "functional"])
    @log_snapshot_after_test
    def deploy_telemetry_resource_event_api(self):
        """Deploy an environment with Openstack-Telemetry and StackLight
        ...
        self._deploy_telemetry_plugin(
            "deploy_telemetry_resource_event_api",
            additional_tests=additional_tests,
            advanced_options=options
        )
