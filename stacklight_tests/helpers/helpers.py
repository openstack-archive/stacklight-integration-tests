...
class timeout(object):
    ...
    def get_tasks_pids(self, processes, nodes=None, exists=True):
        """Get pids for specified process names.

        :param processes: list of process names to get pids for.
        :type process: list
        :param nodes: list of nailgun nodes to look for pids on. Default
            value: all cluster nodes.
        :type nodes: list
        :param exists: boolean flag to specify whether pid should be found
           or not. If set to True an exception will be raised if pid was not
           found.
        :type exists: bool
        :return: dict
        """
