...
class PluginHelper(object):
    ...
    def uninstall_plugin(self, plugin_name, plugin_version, exit_code=0,
        ...
        :type msg: str
        """
        logger.info("Trying to uninstall {} plugin".format(plugin_name))
    ...
    def check_uninstall_plugin_impossible(self, plugin_name, plugin_version):
        """Check plugin cannot be uninstalled.
        ...
        self.uninstall_plugin(
            ...
            exit_code=1,
            msg='Plugin deletion must not be allowed when it is deployed')
