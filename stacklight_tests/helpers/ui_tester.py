...
def get_driver(url, anchor, title, by_selector_type=by.By.XPATH):
    ...
    if os.environ.get('SELENIUM_MAXIMIZE', True):
        driver.maximize_window()
    driver.implicitly_wait(os.environ.get('IMPLICIT_WAIT', 5))
    driver.set_page_load_timeout(os.environ.get('PAGE_TIMEOUT', 15))
    driver.get(url)
