...
def import_tests():
    ...
    from stacklight_tests.kafka_plugin import test_functional  # noqa
    from stacklight_tests.kafka_plugin import test_smoke_bvt  # noqa
    from stacklight_tests.kafka_plugin import test_system  # noqa
