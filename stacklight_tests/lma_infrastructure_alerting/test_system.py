...
class TestLMAInfraAlertingPluginSystem(api.InfraAlertingPluginApi):
    ...
    @test(depends_on=[smoke.deploy_ha_lma_infrastructure_alerting],
          groups=["lma_infrastructure_alerting_add_remove_controller",
                  "system", "lma_infrastructure_alerting", "scaling"])
    @log_snapshot_after_test
    def lma_infrastructure_alerting_add_remove_controller(self):
    ...
    @test(depends_on=[smoke.deploy_ha_lma_infrastructure_alerting],
          groups=["lma_infrastructure_alerting_add_remove_compute", "system",
                  "lma_infrastructure_alerting", "scaling"])
    @log_snapshot_after_test
    def lma_infrastructure_alerting_add_remove_compute(self):
    ...
    @test(depends_on=[smoke.deploy_ha_lma_infrastructure_alerting],
          groups=["add_remove_infrastructure_alerting", "system",
                  "lma_infrastructure_alerting", "scaling"])
    @log_snapshot_after_test
    ...
    @test(depends_on=[smoke.deploy_ha_lma_infrastructure_alerting],
          groups=["shutdown_infrastructure_alerting", "system",
