...
class InfluxdbPluginApi(base_test.PluginApi):
    ...
    def check_cluster_status(self, name, state=0, interval='3m'):
    ...
    def check_count_of_haproxy_backends(self, service, node_state='down',
        ...
        self.check_influx_query(query, expected_count, msg_header)

    def check_influx_query(self, query, expected_value, msg_header):
