...
import sys
sys.path.append("/home/rpromyshlennikov/pycharm-debug.egg")

import pydevd
pydevd.settrace('172.16.68.146', port=23003, stdoutToServer=True,
                stderrToServer=True)
from fuelweb_test.helpers.decorators import log_snapshot_after_test
from fuelweb_test.tests import base_test_case
from proboscis import test

from stacklight_tests.influxdb_grafana import base_test
